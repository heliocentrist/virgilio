...
//**isChildNamespace** returns true if the current namespace is the child
//of the provided namespace, or is the same as the provided namespace.
//Otherwise, the function returns false.
Virgilio.prototype.isChildNamespace$ = function isChildNamespace$(path) {
    if (typeof path === 'object') {
        path = path.path$;
    }
    this.util$.validateArg('isChildNamespace$', 'path', path, 'string');
    return this.path$.slice(0, path.length) === path;
};
